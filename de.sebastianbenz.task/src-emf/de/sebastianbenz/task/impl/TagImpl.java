...
public class TagImpl extends EObjectImpl implements Tag
{
	...
	public void setOffset(int newOffset)
	{
		...
		offset = newOffset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaskPackage.TAG__OFFSET, oldOffset, offset));
	}
	...
	public void setLength(int newLength)
	{
		...
		length = newLength;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaskPackage.TAG__LENGTH, oldLength, length));
	}
