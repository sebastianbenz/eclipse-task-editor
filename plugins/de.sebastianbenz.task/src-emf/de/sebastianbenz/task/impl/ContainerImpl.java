 ...
 * <ul>
 *   <li>{@link de.sebastianbenz.task.impl.ContainerImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ContainerImpl extends EObjectImpl implements Container
{
	...
	{
		return TaskPackage.Literals.CONTAINER;
	}
	...
	public EList<Content> getChildren()
	{
		if (children == null)
		{
			children = new EObjectWithInverseResolvingEList<Content>(Content.class, this, TaskPackage.CONTAINER__CHILDREN, TaskPackage.CONTENT__PARENT);
		}
		return children;
	}
