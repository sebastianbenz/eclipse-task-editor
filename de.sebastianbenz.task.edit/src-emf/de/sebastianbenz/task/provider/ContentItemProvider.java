...
/**
 * This is the item provider adapter for a {@link de.sebastianbenz.task.Content} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
	{
		if (itemPropertyDescriptors == null) {
			...
			addIntendPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Intend feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIntendPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Content_intend_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Content_intend_feature", "_UI_Content_type"),
				 TaskPackage.Literals.CONTENT__INTEND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TaskPackage.Literals.CONTENT__TEXT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	{
		return shorten( ((Content)object).getValue());
	}
