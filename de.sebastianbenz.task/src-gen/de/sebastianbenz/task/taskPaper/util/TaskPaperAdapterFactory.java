 ...
 * @generated
 */
public class TaskPaperAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  public TaskPaperAdapterFactory()
  {
   ...
   * @generated
   */
  protected TaskPaperSwitch<Adapter> modelSwitch =
    new TaskPaperSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.sebastianbenz.task.taskPaper.Todo <em>Todo</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.sebastianbenz.task.taskPaper.Content <em>Content</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.sebastianbenz.task.taskPaper.Task <em>Task</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.sebastianbenz.task.taskPaper.Project <em>Project</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
